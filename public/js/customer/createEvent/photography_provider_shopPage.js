...
halls.onchange = function() {
  ...
  window.location.href = "http://localhost:80/EventsLab/src/php/customer/createEvent/photography_provider_shopPage.php?option_id="+option_id+"&"+"sp_id="+sp_id+"&"+"pack_id="+pack_id;
