if (typeof window !== 'undefined') { 
  ...
  var option_id = halls.value;
   ...
   window.location.href = "http://localhost:80/EventsLab/src/php/customer/outsidersView/outsider_photography_shoppage.php?option_id="+option_id+"&"+"sp_id="+sp_id+"&"+"pack_id="+pack_id;
