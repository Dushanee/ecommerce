...
<head>
    ...
    <script type="text/javascript" src="../../../../public/customer/js/outsidersView/outsider_venue.js" defer></script>
    <link rel="stylesheet" href="../../../../public/customer/css/front.css">
    <link rel="stylesheet" href="../../../../public/customer/css/first.css">
    <link rel="stylesheet" href="../../../../public/customer/css/outsidersView/venue.css">
...
<body>
   ...
   <div id="navBar">
    ...
    <a class="aboutus p" id="a" href="http://localhost:80/EventsLab/public/customer/html/front.html" >Home</a>
       <a class="blog p" id="a" href="http://localhost:80/EventsLab/public/customer/html/second.html" >Blog</a>
       <a class="customerSpt p" id="a" href="http://localhost:80/EventsLab/public/customer/html/">Customer Support</a>
       ...
       <a class="login p" id="a" href="http://localhost:80/EventsLab/public/html/reg_as.html">Log In</a>
       <a class="signup p" id="a" href="http://localhost:80/EventsLab/public/customer/html/selectUserType.html">Sign Up</a>
    </div>
    ...
    <div id="content">
     ...
     <h2 id="h2">Create an event</h2>
      ...
      <?php
       ...
       $sql = "SELECT * FROM packages INNER JOIN service_providers ON packages.sp_id = service_providers.sp_id WHERE service_providers.sp_type = 'venue'";
                ...
                while($row = mysqli_fetch_assoc($result1)){
                  $min_option_id = $row['MIN(option_id)'];
                       ...
                       "<div class='card'>".
                         ...
                         "<form action='outsider_venue_shopPage.php' method='POST'>".
    ...
    <!-- <div class="footer" id="footer1">
     ...
     <div class="rights_footer">
       <p>Copyrights reserved</p>
         ...
         <img src="../../../../public/customer/image/images1/rating/">
    </body>
</html>