...
<head>
    ...
    <link rel="stylesheet" href="../../../../public/customer/css/outsidersView/sound_light_provider_shop.css">
    <script type="text/javascript" src="../../../../public/customer/js/outsidersView/outsider_sound_light_shoppage.js" defer></script>
...
<body>
    ...
    <div id="sp_info">
     ...
     <!-- <div id="spImg">
      ...
      $sql = "SELECT * FROM packages INNER JOIN service_providers ON packages.sp_id = service_providers.sp_id WHERE service_providers.sp_type = 'sounds' AND packages.pack_id = $pack_id";
