...
<head>
    ...
    <script type="text/javascript" src="../../../../public/customer/js/outsidersView/outsider_photography.js" defer></script>
    <link rel="stylesheet" href="../../../../public/customer/css/front.css">
    <link rel="stylesheet" href="../../../../public/customer/css/first.css">
    <link rel="stylesheet" href="../../../../public/customer/css/outsidersView/photography.css">
...
<body>
   ...
   <div id="navBar">
    ...
    <a class="aboutus p" id="a" href="http://localhost:80/EventsLab/public/customer/html/front.html" >Home</a>
       ...
       <a class="signup p" id="a" href="http://localhost:80/EventsLab/public/customer/html/selectUserType.html">Sign Up</a>6
    </div>
                ...
                while($row = mysqli_fetch_assoc($result1)){
                  $min_option_id = $row['MIN(option_id)'];
                       ...
                       "<div class='card'>".
                         ...
                         "<form action='outsider_photography_shopPage.php' method='POST'>".
