...
<head>
    ...
    <script type="text/javascript" src="../../../../public/customer/js/outsidersView/outsider_food.js" defer></script>
    <link rel="stylesheet" href="../../../../public/customer/css/front.css">
    <link rel="stylesheet" href="../../../../public/customer/css/first.css">
    <link rel="stylesheet" href="../../../../public/customer/css/outsidersView/food.css">
    ...
    <div id="content">
     ...
     <h2 id="h2">Create an event</h2>
      ...
      <?php
       ...
       $sql = "SELECT * FROM packages INNER JOIN service_providers ON packages.sp_id = service_providers.sp_id WHERE service_providers.sp_type = 'cater'";
                ...
                while($row = mysqli_fetch_assoc($result1)){
                  $min_option_id = $row['MIN(option_id)'];
                       ...
                       "<div class='card'>".
                         ...
                         "<form action='outsider_food_shopPage.php' method='POST'>".
