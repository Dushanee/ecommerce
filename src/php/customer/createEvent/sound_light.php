...
<head>
    ...
    <script type="text/javascript" src="../../../../public/customer/js/createEvent/sound_light.js" defer></script>
    <link rel="stylesheet" href="../../../../public/customer/css/front.css">
    <link rel="stylesheet" href="../../../../public/customer/css/first.css">
    <link rel="stylesheet" href="../../../../public/customer/css/createEvent/sound_light.css">
                ...
                while($row = mysqli_fetch_assoc($result1)){
                  $min_option_id = $row['MIN(option_id)'];
                       ...
                       "<div class='card'>".
                         ...
                         "<form action='sound_light_provider_shop.php' method='POST'>".
