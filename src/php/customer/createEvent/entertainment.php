...
<head>
    ...
    <script type="text/javascript" src="../../../../public/customer/js/createEvent/entertainment.js" defer></script>
    <link rel="stylesheet" href="../../../../public/customer/css/front.css">
    <link rel="stylesheet" href="../../../../public/customer/css/first.css">
    <link rel="stylesheet" href="../../../../public/customer/css/createEvent/entertainment.css">
                ...
                while($row = mysqli_fetch_assoc($result1)){
                  $min_option_id = $row['MIN(option_id)'];
                       ...
                       "<div class='card'>".
                         ...
                         "<form action='entertainment_provider_shopPage.php' method='POST'>".
