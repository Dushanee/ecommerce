...
<head>
    ...
    <link rel="stylesheet" href="../../../../public/customer/css/createEvent/decoration_provider_shopPage.css">
    <script type="text/javascript" src="../../../../public/customer/js/createEvent/decoration_provider_shopPage.js" defer></script>
...
<body>
    ...
    <div id="sp_info">
     ...
     <!-- <div id="spImg">
      ...
      $sql = "SELECT * FROM packages INNER JOIN service_providers ON packages.sp_id = service_providers.sp_id WHERE service_providers.sp_type = 'deco' AND packages.pack_id = $pack_id";
      $result = mysqli_query($conn, $sql);
