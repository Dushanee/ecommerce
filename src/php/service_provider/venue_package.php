     ...
     if(isset($_POST['addpackage'])){
        ...
        if($num_of_options != ""){
          while($var_pos <= $num_of_options){
              ...
              $option_capacity = $_POST['capacity'.$var_pos];
              $data[$data_pos] = $option_capacity;
              $data_pos++;

              $capacityArray[$capacity_pos] = $option_capacity;
              $capacity_pos++;
         ...
         $sql = "SELECT pack_id FROM packages WHERE sp_id = '$sp_id'";
         $result = mysqli_query($connection,$sql);
         if($result == true){
         ...
         $sql = "INSERT INTO options(pack_id,option_name,option_description,option_rate,optionPic1,optionPic2,optionPic3,optionPic4) VALUES ('$pack_id','$option_name','$option_description','$option_rate','$imageName1','$imageName2','$imageName3','$imageName4')";
         $result = mysqli_query($connection,$sql);
         ...
         if($result1 == true) {
           if(mysqli_num_rows($result1)>0){
            ...
            while($row = mysqli_fetch_assoc($result1)){
                ...
                $sql2 = "INSERT INTO venue_pack_options (option_id,capacity) VALUES ('$row[option_id]', '$capacityArray[$capacity_pos]')";
